...
- Real Data Warehouse/API sync feed, KPI read endpoint, and broader SQL integration proof beyond the current fixture-backed sync/order-list coverage.
